...
export const MOCK_WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    title: "Mountain Tea Afternoon on the Tea Horse Road",
    description:
    ...
    highlights: [
      "Private host · max 6",
      "Fire-roasted tea on site",
      "Forest walk & Tea Horse Road stories",
      "Sunset gongfu session",
    ],
    includes: [
      "Private transport from Chengdu area",
      "Forest walk with Chen",
      "Fire-roasted & aged tea tastings",
      "Seasonal local lunch",
      "Sunset gongfu ceremony",
    ],
    host_name: "Chen Yu",
    host_bio:
